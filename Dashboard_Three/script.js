...
const downloadData = () => {
    ...
    axios.get('https://research.iitmandi.ac.in:8196/user/download')
...
function fetchSensorValues() {
    $.ajax({
        url: "https://research.iitmandi.ac.in:8196/act/getvalues/polyhouse1",
        method: "GET",
        dataType: "json",
...
function updateSensor(sensor, value) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            fetch('https://research.iitmandi.ac.in:8196/act/updatevalues/polyhouse1', {
                method: 'PATCH',
                headers: {
...
function fetchSensorValues_2() {
    $.ajax({
        url: "https://research.iitmandi.ac.in:8196/act/getvalues/polyhouse2",
        method: "GET",
        dataType: "json",
        success: function (data) {
            var sensorData = data[0].plants[0].sensors;
...
function updateSensor_2(sensor, value) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            fetch('https://research.iitmandi.ac.in:8196/act/updatevalues/polyhouse2', {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                },
...
axios.get('https://research.iitmandi.ac.in:8196/sensor/polyhouse1/data')
    .then(response => {
...
axios.get('https://research.iitmandi.ac.in:8196/sensor/polyhouse2/data')
    .then(response => {
        const data = response.data;
        const timeStamps = data.result.map(getTimeStamps);
        const latestEntry = data.result.slice(-1)[0].timestamp;
