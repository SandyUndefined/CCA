...
export const FONT_TWO = "https://fonts.gstatic.com"
...
//user profile and google auth and data download endpoints
export const USER_PROFILE_URL = "localhost:8000/user/userProfile";
export const GOOGLE_AUTH_URL = "localhost:8000/user/auth/google";
